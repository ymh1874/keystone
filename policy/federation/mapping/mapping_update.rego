...
package identity.federation.mapping.update

import data.identity.federation as common_federation

# Update mapping.
#
# The `input.target.mapping` is the update patch (MappingUpdate):
#   name:                  string (optional)  Attribute mapping name.
#   domain_id:             string (optional)  `domain_id` owning the attribute mapping.
#   idp_id:                string (optional)  ID of the federated identity provider.
#   type:                  string (optional)  Attribute mapping type.
#   enabled:               bool (optional)    Mapping enabled property.
#   allowed_redirect_uris: array (optional)   List of allowed redirect urls.
#   user_id_claim:         string (optional)  `user_id` claim name.
#   user_name_claim:       string (optional)  `user_name` claim name.
...
#   bound_claims:          object (optional)  Additional claims.
...
#
# The `input.existing.mapping` is the stored mapping object (Mapping):
